...
public class MusicManager
	 ...
	 */
	public enum BattleAsteroidsMusic
	{
	    MENU( "music/menu.ogg" ),
	 ...
	 */
	private BattleAsteroidsMusic musicBeingPlayed;
			...
			BattleAsteroidsMusic music )
	{
	    ...
	    // do some logging
	    Gdx.app.log( BattleAsteroidsGame.LOG, "Playing music: " + music.name() );
	...
	public void stop()
	{
	    if( musicBeingPlayed != null ) {
	        Gdx.app.log( BattleAsteroidsGame.LOG, "Stopping current music" );
	...
	public void setVolume(
	    float volume )
	{
	    Gdx.app.log( BattleAsteroidsGame.LOG, "Adjusting music volume to: " + volume );
	...
	public void dispose()
	{
	    Gdx.app.log( BattleAsteroidsGame.LOG, "Disposing music manager" );
	    stop();
	}
}
