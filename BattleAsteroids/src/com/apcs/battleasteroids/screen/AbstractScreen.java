...
public class AbstractScreen implements Screen {
    ...
    protected final BattleAsteroidsGame game;
 ...
 // Lazily loaded collaborators
    ...
    protected Table getTable()
    {
        if( table == null ) {
            ...
            if( BattleAsteroidsGame.DEV_MODE ) {
                table.debug();
            }
	...
	public void show() {
		// TODO Auto-generated method stub
		Gdx.app.log( BattleAsteroidsGame.LOG, "Showing screen: " + getName() );
	...
	public void hide() {
		// TODO Auto-generated method stub
		Gdx.app.log( BattleAsteroidsGame.LOG, "Hiding screen: " + getName() );
	...
	public void pause() {
		// TODO Auto-generated method stub
		Gdx.app.log( BattleAsteroidsGame.LOG, "Pausing screen: " + getName() );
	}
	@Override
	public void resume() {
		// TODO Auto-generated method stub
		 Gdx.app.log( BattleAsteroidsGame.LOG, "Resuming screen: " + getName() );
	}
	@Override
	public void dispose() {
		// TODO Auto-generated method stub
		Gdx.app.log( BattleAsteroidsGame.LOG, "Disposing screen: " + getName() );
